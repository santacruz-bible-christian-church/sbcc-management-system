...
class PrayerRequestViewSet(viewsets.ModelViewSet):
    ...
    def add_follow_up(self, request, pk=None):
        ...
        serializer = PrayerRequestFollowUpSerializer(data={
            **request.data,
    ...
    def statistics(self, request):
        ...
        by_status = dict(
            PrayerRequest.objects.values("status")
    ...
    def download(self, request):
        ...
        writer.writerow([
            ...
            "Requester", "Assigned To", "Submitted At", "Updated At"
        ])
...
class PrayerRequestFollowUpViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        user = self.request.user
        queryset = PrayerRequestFollowUp.objects.select_related(
            "prayer_request", "created_by"
        )
        
        # Filter private notes for non-pastor users
        if user.role not in ["pastor", "admin"]:
